      ...
      <div className="flex flex-wrap justify-center items-center m-4">
        {Array(12)
          ...
          .map((e, index) => (
            <div
              key={index}
              className="flex flex-wrap w-60 h-72 p-3 m-6 shadow-2xl bg-slate-200 rounded-md animate-pulse"
            >
              <div className="w-full h-40 bg-slate-400 animate-pulse rounded-md"></div>
              <h3 className="w-full h-6 bg-slate-500 my-2 rounded-md"></h3>
              <h4 className="w-3/4 h-8 bg-slate-400 rounded-md"></h4>
              <div className="w-full my-2 h-8 grid grid-cols-3 gap-4">
